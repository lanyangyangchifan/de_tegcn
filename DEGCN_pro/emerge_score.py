...
# ./work_dir/test/test_A/75_8_test_score.pkl
file_name1 = './work_dir/test/test_B/75_85_test_score.pkl'
# file_name2 = './work_dir/test/test_A/76_6_test_score.pkl'
file_name3 = './work_dir/test/test_B/76_65_test_score.pkl'
# file_name3 = './work_dir/test/test_A/75_8_test_score.pkl'
...
# value_list4 = list(data_dict4.values())  # 提取字典的值
# array4 = np.array(value_list4)
# 计算加权平均数组
weight1 = 3/11
weight2 = 4/11
weight3 = 4/11
weight4 = 0.0
weighted_average = weight1 * array1 + weight2 * array2 + weight3 * array3 + weight3 * array3 #+ weight4 * array4
#0.3 0.4 0.4 相同位置的百分比： 77.8
#以下两个代码块根据需要注释一个
