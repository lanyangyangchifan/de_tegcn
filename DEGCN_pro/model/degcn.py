...
class Model(nn.Module):
    ...
    def __init__(self, num_class=155, num_point=17, num_person=2, k=8, eta=4, num_stream=2, 
                 graph=None, graph_args=dict(), in_channels=3, drop_out=0,):                 
        ...
        # self.blockargs = [
        #     [in_channels, base_channel, 1, False, 300, num_point],  # 第一层处理300帧
        #     [base_channel, base_channel, 1, True, 300, num_point],
        #     [base_channel, base_channel, 1, True, 150, num_point],  # 逐步减半
        #     [base_channel, base_channel, 1, True, 75, num_point],
        #     [base_channel, base_channel*2, 2, True, 75, num_point],
        #     [base_channel*2, base_channel*2, 1, True, 38, num_point],
        #     [base_channel*2, base_channel*4, 2, True, 38, num_point],
        #     [base_channel*4, base_channel*4, 1, True, 19, num_point]
        # ]
