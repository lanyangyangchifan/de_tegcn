...
with open('./data/val_data.npz', 'rb') as file1:
    ...
    print(x_va.shape)
np.save('./data/TEgcn_有数据预处理/test_joint.npy',x_te)
np.save('./data/TEgcn_有数据预处理/val_joint.npy',x_va)
np.save('./data/TEgcn_有数据预处理/train_joint.npy',x_tr)
np.save('./data/TEgcn_有数据预处理/train_label.npy',y_tr)
